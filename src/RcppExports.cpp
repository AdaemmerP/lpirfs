...
// newey_west_iv
List newey_west_iv(NumericVector y, NumericMatrix x, int h);
RcppExport SEXP _lpirfs_newey_west_iv(SEXP ySEXP, SEXP xSEXP, SEXP hSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type h(hSEXP);
    rcpp_result_gen = Rcpp::wrap(newey_west_iv(y, x, h));
    return rcpp_result_gen;
END_RCPP
}
// newey_west
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_lpirfs_newey_west_iv", (DL_FUNC) &_lpirfs_newey_west_iv, 3},
