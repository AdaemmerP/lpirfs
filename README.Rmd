...
After installation, you have to open a terminal and start R via 'PATH=/usr/local/clang6/bin:$PATH R'. 
Yo then have to install the package via *devtools::install_github("AdaemmerP/lpirfs")*
