...
results_lin <- lp_lin(endog_data, 
                           lags_endog_lin = 4L,   # Number of lags for endogenous data
...
results_nl <- lp_nl(endog_data, 
                        lags_endog_lin = 4L,   # Number of lags for (reduced) linear VAR to obtain shock matrix. 
                        lags_endog_nl  = 4L,   # Number of lags for nonlinear model. 
                        lags_criterion = NaN,  # Lag length criterion (AICc, AIC or BIC) or NaN.
