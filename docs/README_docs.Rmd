...
Load data set from package to estimate a non-linear, new-Keynesian, closed-economy 
...
Non-linear impulse responses are computed as in [Ahmed and Cassou (2016)](https://www.sciencedirect.com/science/article/pii/S0164070416300490). 
First, a reduced VAR is estimated to obtain the covariance matrix of the residuals $\Sigma$. The Cholesky decomposition is then applied to obtain the shock matrix with columns denoted by $d_i$. IRFs for both regimes are estimated via:
